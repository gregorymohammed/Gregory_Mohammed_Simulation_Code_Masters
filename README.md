...
### and the totalTimeKKT value (in seconds).
...
courant = 0.4
### p1 small for KKT, and Sod with total time > 0.25.p1 = 0.4
...
### THIS IS NOT WORKING. IT WAS INCLUDED FOR FUTURE WORK.
